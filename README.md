...
The project was deployed using [Heroku](https://www.heroku.com/) and [Netlify](https://www.netlify.com/) and can be found [here](https://cloudify-player.netlify.app/) (it may be necessary to give the app 1 minute to wake up).
